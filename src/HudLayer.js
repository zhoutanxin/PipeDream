...
State.createHero = function(){
	...
	var s1 = cc.Sprite.create(res.s_HeroState1);
	var s2 = cc.Sprite.create(res.s_HeroState2);
	var s3 = cc.Sprite.create(res.s_HeroState3);
	var s4 = cc.Sprite.create(res.s_HeroState4);
	...
	var title = cc.LabelTTF.create("Lv7  A新", "Tahoma", 14);
...
State.createRobot = function(){
	var state = State.create();
	var s1 = cc.Sprite.create(res.s_RobotState1);
	var s2 = cc.Sprite.create(res.s_RobotState2);
	var s3 = cc.Sprite.create(res.s_RobotState3);
	var s4 = cc.Sprite.create(res.s_RobotState4);
	...
	var title = cc.LabelTTF.create("Lv5 Monster", "Tahoma", 14);
...
var HudLayer = cc.Layer.extend({
	...
	init:function(){
		...
		if(this._super()){
			...
			this.mAttack = AttackButton.initWithImage(res.s_Attack);
...
//			添加特效攻击
			var attackA = cc.Sprite.create(res.s_AttackA);
			this.mAttackA = AttackEffect.initWithImage(res.s_AttackA);
			...
			var attackB = cc.Sprite.create(res.s_AttackB);
			this.mAttackB = AttackEffect.initWithImage(res.s_AttackB);
