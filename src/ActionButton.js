	...
	onEnter:function(){
        ...
        cc.eventManager.addListener({event: cc.EventListener.TOUCH_ONE_BY_ONE,
            ...
            containsTouchLocation:function(touch){
                return cc.rectContainsPoint(thisBtn.rect(), thisBtn.convertTouchToNodeSpace(touch));
            },
            onTouchEnded:function(touch, event){
                thisBtn.endedAnimation();
            }
        },this);
	},
	onExit:function(){
...
var AttackButton = ActionButton.extend({
	...
	ctor:function(){
		this._super();
		this._pt= cc.Sprite.create(res.s_AttackO);
...
var AttackEffect = ActionButton.extend({
	...
	ctor:function(){
		this._super();
		var h = cc.Sprite.create(res.s_AttackFreeze);
